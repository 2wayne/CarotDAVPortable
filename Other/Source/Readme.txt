...
user in an INI file next to CarotDAVPortable.exe called CarotDAVPortable.ini.
...
copy AppNamePortable.ini from this directory to CarotDAVPortable.ini next to
CarotDAVPortable.exe. The options in the INI file are as follows:
